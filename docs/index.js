...
let gifts = {
  ...
  'Braxton': [],
  'Isla': [],
  'Jeff': ["LEGO", "2+ player board games", "sloth"],
  'Erinn': ["LEGO", "2+ player board games"],
  'Ben': ["Minecraft merch", "Frieren merch"],
  'Milo': ["Super Kitties merch", "Blaze and the Monster Machines or other monster truck stuff", "Clothes", "Construction Trucks"],
  'Erin': [],
  'Anika': [],
  'Edwin': [],
  'Matt': [],
